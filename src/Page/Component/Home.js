    ...
    <div className="container" style={{ padding: '10px' }}>
      <div className='header'>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingRight: '20px' }}>
          <div>
            <img src='https://th.bing.com/th/id/OIP.HSGUJ_6yiaHHIEIzJIuYjQHaEK?rs=1&pid=ImgDetMain' style={{ cursor: 'pointer' }} width='70px' alt='' />
          </div>
          ...
          <div style={{ position: 'relative' }}>
            <h4 style={{ marginLeft: '75px', cursor: 'pointer', position: 'absolute', top: '-1px', fontSize: '10px', color: 'red' }}>
              NEW
            </h4>
            <h4 style={{ marginLeft: '20px', cursor: 'pointer', fontFamily: 'Arial', fontSize: '14px' }}>STUDIO</h4>
          </div>
          <div>
            <div style={{ position: 'absolute', marginTop: '-15px', display: 'flex', alignItems: 'center' }}>
              <input
                type="text"
        ...
        <div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: '530px' }}>
            <img src='https://th.bing.com/th/id/OIP.k0WudKouhn3Zcqw_KYhI7gHaHa?rs=1&pid=ImgDetMain' width='20px' alt='' />
        ...
        <div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginRight: '10px' }}>
            <img src='https://cdn4.iconfinder.com/data/icons/e-commerce-ui-outline/64/ecommerce_-_love_favorite-512.png' width='20px' alt='' />
            <h5 style={{ margin: '0', cursor: 'pointer', fontFamily: 'Arial', marginTop: '7px' }}>Wishlist</h5>
          </div>
        </div>

        <div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginRight: '20px' }}>
            <img src='https://th.bing.com/th/id/R.221f444e27f88309ea3c7bd60935276c?rik=BSlcpmNFk3TSgA&riu=http%3a%2f%2fwww.clipartbest.com%2fcliparts%2fjTx%2f6zo%2fjTx6zoqpc.png&ehk=xwgI27%2fMVn3tPj0J6zMu4VNqPR5b022rVcmfmUNgv2U%3d&risl=&pid=ImgRaw&r=0' width='20px' alt='' />
            <h5 style={{ margin: '0', cursor: 'pointer', fontFamily: 'Arial', marginTop: '7px' }}>Bag</h5>
          </div>
        </div>
      </div>
      <hr style={{ width: '1300px', marginLeft: '1px', marginTop: '1px', borderTop: '#e0e0e0' }}></hr>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <div>
          <h3 style={{ margin: '0', marginRight: '10px', fontFamily: 'Arial', fontSize: '15px' }}>T-Shirts For Men & Women</h3>
        </div>
        <div>
      ...
      <div className='component'>
        <div className='filters'>
          <h4 style={{ display: 'flex', flexDirection: 'column', fontFamily: 'Arial', fontSize: '15px' }}>FILTERS</h4>

          <div className="dropdown" style={{ marginLeft: '200px' }}>
            ...
            <div className={`dropdown-content ${dropdownOpen ? 'show' : ''}`} id="checkbox-container">
              ...
              <input type="checkbox" id="checkbox" />
              <label htmlFor="checkbox" style={{ width: '100px' }}>Single Styles</label>
            </div>
          </div>


          <div className="dropdown" style={{ marginLeft: '50px', cursor: 'pointer' }}>
            <span onClick={toggleDropdown} style={{ display: 'flex', alignItems: 'center', width: '200px', fontFamily: 'Arial', fontSize: '12px' }}>
              Country of Origin
            </span>
            <div className={`dropdown-content ${dropdownOpen ? 'show' : ''}`} id="checkbox-container">
              <input type="checkbox" id="checkbox" />
              <label htmlFor="checkbox">All Countries</label>
          ...
          <div className="dropdown" style={{ marginLeft: '80px', cursor: 'pointer' }}>
          ...
          <div class="sort-sortBy">
            <div class="SortDesktop__base">
              <div class="SelectBoxDesktop__base">
                <select class="SelectBoxDesktop__hideSelect" label="Recommended">
                  <option value="relevance" label="Recommended">Recommended</option>
                  <option value="isDiscountedPrice" label="Whats New">Whats New</option>
                  <option value="isDiscountedPrice" label="Popularity">Popularity</option>
                  <option value="isDiscountedPrice" label="Better Discounts">Better Discount</option>
                  ...
                  <option value="isProductNew" label="Customer Ratings">Customer Ratings</option>
                </select>
                <div class="SelectBoxDesktop__visibleBoxWithLeftChild">Recommended</div>
                <div class="SelectBoxDesktop__arrow">
                </div>
                <div class="SelectBoxDesktop__boxIconLeft" style={{marginTop: '-30px'}}>Sort by :</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginTop: '10px', fontSize: '12px' }}>
            ...
            <hr style={{ width: '250px', marginLeft: '1px', marginTop: '1px' }}></hr>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginTop: '10px', fontFamily: 'Arial', fontSize: '12px' }}>
            ...
            <div class="brands"></div>
            <hr style={{ width: '250px', marginLeft: '1px', marginTop: '-4px' }}></hr>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginTop: '10px', fontFamily: 'Arial', fontSize: '12px' }}>
            ...
            <hr style={{ width: '1050px', marginLeft: '270px', marginTop: '-4px' }}></hr>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '12px' }}>
            ...
            <div style={{ marginRight: '0px', marginTop: '-1550px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial' }}>
              <img src='https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/24454624/2023/9/1/c98f9297-0518-4eab-8423-fb29c18c4e281693549946114-Allen-Solly-Men-Black-Polo-Collar-T-shirt-3211693549945619-1.jpg'
                style={{ cursor: 'pointer', display: 'block' }} width='200px' alt='' />
              <h3>Allen Solly</h3>
              <span style={{ marginTop: '-5px', color: '#888', cursor: 'pointer' }}>Polo Coller T-shirt</span>
              <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div style={{ marginRight: '10px', marginTop: '-1550px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial' }}>
              <img src='https://lowpricesaree.in/wp-content/uploads/2022/04/roadster-men-navy-solid-round-neck-t-shirt.jpg'
                style={{ cursor: 'pointer', display: 'block' }} width='200px' alt='' />
              <h3>Roadster</h3>
              <span style={{ marginTop: '-5px', color: '#888', cursor: 'pointer' }}>Solid Round Neck T-shirt</span>
              <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div style={{ marginRight: '10px  ', marginTop: '-1550px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial' }}>
              <img src='https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/25744596/2023/11/3/bc8d5a97-38ef-4ee1-b14b-5b479836a0c01699005447177ElibolzMenBlackPrintedV-NeckPocketsT-shirt1.jpg'
                style={{ cursor: 'pointer', display: 'block' }} width='200px' alt='' />
              <h3>Elibolz</h3>
              <span style={{ marginTop: '-5px', color: '#888', cursor: 'pointer' }}>Cotton Oversized T-shirt</span>
              <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ marginLeft: '270px', marginTop: '-800px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial', fontSize: '12px' }}>
            ...
            <div style={{ marginLeft: '80px', marginTop: '-800px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial', fontSize: '12px' }}>
            ...
            <div style={{ marginLeft: '70px', marginTop: '-800px', display: 'flex', flexDirection: 'column', fontFamily: 'Arial', fontSize: '12px' }}>
        ...
        <div className='page'>
          ...
          <ul class="pagination">
            ...
            <li><button class="active" style={{ marginLeft: '30px', border: '1px solid', width: '80px', fontWeight: 'bold' }}>NEXT</button></li>
          </ul>
        </div>
      </div>
    </div>
